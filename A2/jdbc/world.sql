...
--
-- The schema is called Countries in PCRS.
--
-- This version of the data is called "Countries_World_Fixed" in PCRS.  
-- It the same as the earlier version called just "Countries_World" 
-- except that the non-ascii characters that were inadvertently included
-- in that dataset have been corrected.
...
('CIV','Cote d''Ivoire','Africa',14786000),
